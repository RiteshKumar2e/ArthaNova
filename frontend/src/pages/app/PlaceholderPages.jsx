...
export const FilingsAnalyzerPage = () => <GenericPage title="Filings Analyzer" description="Extract insights from 10-K, 10-Q, Annual Reports using LLMs" icon="📋" />
export const NotificationsPage = () => <GenericPage title="Notifications" description="Your timeline of important market events" icon="🔔" />
export const SettingsPage = () => <GenericPage title="Settings" description="Manage app preferences and API keys" icon="⚙️" />
export const AdminPanelPage = () => <GenericPage title="Admin Panel" description="Manage the ArthaNova platform and user accounts" icon="🛠️" />
